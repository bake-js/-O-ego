...
class FloatField extends Echo(HTMLElement) {
  ...
  @attributeChanged("radix")
  @dispatchEvent("radixed")
  @joinCut(setMask)
  set radix(value) {
    this.#radix = value;
  }
  ...
  @attributeChanged("scale")
  @dispatchEvent("scaled")
  @joinCut(setMask)
  set scale(value) {
    this.#scale = value;
  }
  ...
  [setMask]() {
    ...
    const options = {
      ...
      scale: this.scale, // Precisão de centavos (duas casas decimais)
      thousandsSeparator: this.thousandsSeparator, // Define o ponto como separador de milhares
      radix: this.radix, // Define a vírgula como separador decimal
      padFractionalZeros: true, // Preenche com zeros até completar 2 casas decimais
